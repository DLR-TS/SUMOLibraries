...
/* initializing the EPSG defs list */
    ...
    add_srs_wkt (p, 8,
        "NIT[\"metre\",1]],USAGE[SCOPE[\"Geodesy.\"],AREA[\"Cayma");
    add_srs_wkt (p, 9,
        "n Islands - onshore and offshore. Includes Grand Cayman,");
    add_srs_wkt (p, 10,
        " Little Cayman and Cayman Brac.\"],BBOX[17.58,-83.6,20.6");
    add_srs_wkt (p, 11,
        "8,-78.72]],ID[\"EPSG\",6134]]");
