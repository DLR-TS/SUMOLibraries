...
_METHODOPT1 = DESCRIPTOR.enum_types_by_name['MethodOpt1']
MethodOpt1 = enum_type_wrapper.EnumTypeWrapper(_METHODOPT1)
_AGGREGATEENUM = DESCRIPTOR.enum_types_by_name['AggregateEnum']
...
file_opt1 = DESCRIPTOR.extensions_by_name['file_opt1']
MESSAGE_OPT1_FIELD_NUMBER = 7739036
message_opt1 = DESCRIPTOR.extensions_by_name['message_opt1']
FIELD_OPT1_FIELD_NUMBER = 7740936
field_opt1 = DESCRIPTOR.extensions_by_name['field_opt1']
FIELD_OPT2_FIELD_NUMBER = 7753913
field_opt2 = DESCRIPTOR.extensions_by_name['field_opt2']
ONEOF_OPT1_FIELD_NUMBER = 7740111
oneof_opt1 = DESCRIPTOR.extensions_by_name['oneof_opt1']
ENUM_OPT1_FIELD_NUMBER = 7753576
enum_opt1 = DESCRIPTOR.extensions_by_name['enum_opt1']
ENUM_VALUE_OPT1_FIELD_NUMBER = 1560678
enum_value_opt1 = DESCRIPTOR.extensions_by_name['enum_value_opt1']
SERVICE_OPT1_FIELD_NUMBER = 7887650
service_opt1 = DESCRIPTOR.extensions_by_name['service_opt1']
METHOD_OPT1_FIELD_NUMBER = 7890860
method_opt1 = DESCRIPTOR.extensions_by_name['method_opt1']
BOOL_OPT_FIELD_NUMBER = 7706090
bool_opt = DESCRIPTOR.extensions_by_name['bool_opt']
INT32_OPT_FIELD_NUMBER = 7705709
int32_opt = DESCRIPTOR.extensions_by_name['int32_opt']
INT64_OPT_FIELD_NUMBER = 7705542
int64_opt = DESCRIPTOR.extensions_by_name['int64_opt']
UINT32_OPT_FIELD_NUMBER = 7704880
uint32_opt = DESCRIPTOR.extensions_by_name['uint32_opt']
UINT64_OPT_FIELD_NUMBER = 7702367
uint64_opt = DESCRIPTOR.extensions_by_name['uint64_opt']
SINT32_OPT_FIELD_NUMBER = 7701568
sint32_opt = DESCRIPTOR.extensions_by_name['sint32_opt']
SINT64_OPT_FIELD_NUMBER = 7700863
sint64_opt = DESCRIPTOR.extensions_by_name['sint64_opt']
FIXED32_OPT_FIELD_NUMBER = 7700307
fixed32_opt = DESCRIPTOR.extensions_by_name['fixed32_opt']
FIXED64_OPT_FIELD_NUMBER = 7700194
fixed64_opt = DESCRIPTOR.extensions_by_name['fixed64_opt']
SFIXED32_OPT_FIELD_NUMBER = 7698645
sfixed32_opt = DESCRIPTOR.extensions_by_name['sfixed32_opt']
SFIXED64_OPT_FIELD_NUMBER = 7685475
sfixed64_opt = DESCRIPTOR.extensions_by_name['sfixed64_opt']
FLOAT_OPT_FIELD_NUMBER = 7675390
float_opt = DESCRIPTOR.extensions_by_name['float_opt']
DOUBLE_OPT_FIELD_NUMBER = 7673293
double_opt = DESCRIPTOR.extensions_by_name['double_opt']
STRING_OPT_FIELD_NUMBER = 7673285
string_opt = DESCRIPTOR.extensions_by_name['string_opt']
BYTES_OPT_FIELD_NUMBER = 7673238
bytes_opt = DESCRIPTOR.extensions_by_name['bytes_opt']
ENUM_OPT_FIELD_NUMBER = 7673233
enum_opt = DESCRIPTOR.extensions_by_name['enum_opt']
MESSAGE_TYPE_OPT_FIELD_NUMBER = 7665967
message_type_opt = DESCRIPTOR.extensions_by_name['message_type_opt']
QUUX_FIELD_NUMBER = 7663707
quux = DESCRIPTOR.extensions_by_name['quux']
CORGE_FIELD_NUMBER = 7663442
corge = DESCRIPTOR.extensions_by_name['corge']
GRAULT_FIELD_NUMBER = 7650927
grault = DESCRIPTOR.extensions_by_name['grault']
GARPLY_FIELD_NUMBER = 7649992
garply = DESCRIPTOR.extensions_by_name['garply']
COMPLEX_OPT1_FIELD_NUMBER = 7646756
complex_opt1 = DESCRIPTOR.extensions_by_name['complex_opt1']
COMPLEX_OPT2_FIELD_NUMBER = 7636949
complex_opt2 = DESCRIPTOR.extensions_by_name['complex_opt2']
COMPLEX_OPT3_FIELD_NUMBER = 7636463
complex_opt3 = DESCRIPTOR.extensions_by_name['complex_opt3']
COMPLEXOPT6_FIELD_NUMBER = 7595468
complexopt6 = DESCRIPTOR.extensions_by_name['complexopt6']
FILEOPT_FIELD_NUMBER = 15478479
fileopt = DESCRIPTOR.extensions_by_name['fileopt']
MSGOPT_FIELD_NUMBER = 15480088
msgopt = DESCRIPTOR.extensions_by_name['msgopt']
FIELDOPT_FIELD_NUMBER = 15481374
fieldopt = DESCRIPTOR.extensions_by_name['fieldopt']
ENUMOPT_FIELD_NUMBER = 15483218
enumopt = DESCRIPTOR.extensions_by_name['enumopt']
ENUMVALOPT_FIELD_NUMBER = 15486921
enumvalopt = DESCRIPTOR.extensions_by_name['enumvalopt']
SERVICEOPT_FIELD_NUMBER = 15497145
serviceopt = DESCRIPTOR.extensions_by_name['serviceopt']
METHODOPT_FIELD_NUMBER = 15512713
methodopt = DESCRIPTOR.extensions_by_name['methodopt']
REQUIRED_ENUM_OPT_FIELD_NUMBER = 106161807
required_enum_opt = DESCRIPTOR.extensions_by_name['required_enum_opt']

_TESTMESSAGEWITHCUSTOMOPTIONS = DESCRIPTOR.message_types_by_name['TestMessageWithCustomOptions']
_TESTMESSAGEWITHCUSTOMOPTIONS_MAPFIELDENTRY = _TESTMESSAGEWITHCUSTOMOPTIONS.nested_types_by_name['MapFieldEntry']
_CUSTOMOPTIONFOOREQUEST = DESCRIPTOR.message_types_by_name['CustomOptionFooRequest']
_CUSTOMOPTIONFOORESPONSE = DESCRIPTOR.message_types_by_name['CustomOptionFooResponse']
_CUSTOMOPTIONFOOCLIENTMESSAGE = DESCRIPTOR.message_types_by_name['CustomOptionFooClientMessage']
_CUSTOMOPTIONFOOSERVERMESSAGE = DESCRIPTOR.message_types_by_name['CustomOptionFooServerMessage']
_DUMMYMESSAGECONTAININGENUM = DESCRIPTOR.message_types_by_name['DummyMessageContainingEnum']
_DUMMYMESSAGEINVALIDASOPTIONTYPE = DESCRIPTOR.message_types_by_name['DummyMessageInvalidAsOptionType']
_CUSTOMOPTIONMININTEGERVALUES = DESCRIPTOR.message_types_by_name['CustomOptionMinIntegerValues']
_CUSTOMOPTIONMAXINTEGERVALUES = DESCRIPTOR.message_types_by_name['CustomOptionMaxIntegerValues']
_CUSTOMOPTIONOTHERVALUES = DESCRIPTOR.message_types_by_name['CustomOptionOtherValues']
_SETTINGREALSFROMPOSITIVEINTS = DESCRIPTOR.message_types_by_name['SettingRealsFromPositiveInts']
_SETTINGREALSFROMNEGATIVEINTS = DESCRIPTOR.message_types_by_name['SettingRealsFromNegativeInts']
_COMPLEXOPTIONTYPE1 = DESCRIPTOR.message_types_by_name['ComplexOptionType1']
_COMPLEXOPTIONTYPE2 = DESCRIPTOR.message_types_by_name['ComplexOptionType2']
_COMPLEXOPTIONTYPE2_COMPLEXOPTIONTYPE4 = _COMPLEXOPTIONTYPE2.nested_types_by_name['ComplexOptionType4']
_COMPLEXOPTIONTYPE3 = DESCRIPTOR.message_types_by_name['ComplexOptionType3']
_COMPLEXOPTIONTYPE3_COMPLEXOPTIONTYPE5 = _COMPLEXOPTIONTYPE3.nested_types_by_name['ComplexOptionType5']
_COMPLEXOPT6 = DESCRIPTOR.message_types_by_name['ComplexOpt6']
_VARIOUSCOMPLEXOPTIONS = DESCRIPTOR.message_types_by_name['VariousComplexOptions']
_AGGREGATEMESSAGESET = DESCRIPTOR.message_types_by_name['AggregateMessageSet']
_AGGREGATEMESSAGESETELEMENT = DESCRIPTOR.message_types_by_name['AggregateMessageSetElement']
_AGGREGATE = DESCRIPTOR.message_types_by_name['Aggregate']
_AGGREGATEMESSAGE = DESCRIPTOR.message_types_by_name['AggregateMessage']
_NESTEDOPTIONTYPE = DESCRIPTOR.message_types_by_name['NestedOptionType']
_NESTEDOPTIONTYPE_NESTEDMESSAGE = _NESTEDOPTIONTYPE.nested_types_by_name['NestedMessage']
_OLDOPTIONTYPE = DESCRIPTOR.message_types_by_name['OldOptionType']
_NEWOPTIONTYPE = DESCRIPTOR.message_types_by_name['NewOptionType']
_TESTMESSAGEWITHREQUIREDENUMOPTION = DESCRIPTOR.message_types_by_name['TestMessageWithRequiredEnumOption']
_TESTMESSAGEWITHCUSTOMOPTIONS_ANENUM = _TESTMESSAGEWITHCUSTOMOPTIONS.enum_types_by_name['AnEnum']
_DUMMYMESSAGECONTAININGENUM_TESTENUMTYPE = _DUMMYMESSAGECONTAININGENUM.enum_types_by_name['TestEnumType']
_NESTEDOPTIONTYPE_NESTEDENUM = _NESTEDOPTIONTYPE.enum_types_by_name['NestedEnum']
_OLDOPTIONTYPE_TESTENUM = _OLDOPTIONTYPE.enum_types_by_name['TestEnum']
_NEWOPTIONTYPE_TESTENUM = _NEWOPTIONTYPE.enum_types_by_name['TestEnum']
...
_TESTSERVICEWITHCUSTOMOPTIONS = DESCRIPTOR.services_by_name['TestServiceWithCustomOptions']
_AGGREGATESERVICE = DESCRIPTOR.services_by_name['AggregateService']
