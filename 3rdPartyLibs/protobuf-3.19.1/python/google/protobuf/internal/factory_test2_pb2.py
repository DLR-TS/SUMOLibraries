...
_FACTORY2ENUM = DESCRIPTOR.enum_types_by_name['Factory2Enum']
Factory2Enum = enum_type_wrapper.EnumTypeWrapper(_FACTORY2ENUM)
FACTORY_2_VALUE_0 = 0
FACTORY_2_VALUE_1 = 1

ANOTHER_FIELD_FIELD_NUMBER = 1002
another_field = DESCRIPTOR.extensions_by_name['another_field']

_FACTORY2MESSAGE = DESCRIPTOR.message_types_by_name['Factory2Message']
_FACTORY2MESSAGE_NESTEDFACTORY2MESSAGE = _FACTORY2MESSAGE.nested_types_by_name['NestedFactory2Message']
_FACTORY2MESSAGE_GROUPED = _FACTORY2MESSAGE.nested_types_by_name['Grouped']
_LOOPMESSAGE = DESCRIPTOR.message_types_by_name['LoopMessage']
_MESSAGEWITHNESTEDENUMONLY = DESCRIPTOR.message_types_by_name['MessageWithNestedEnumOnly']
_MESSAGEWITHOPTION = DESCRIPTOR.message_types_by_name['MessageWithOption']
_FACTORY2MESSAGE_NESTEDFACTORY2ENUM = _FACTORY2MESSAGE.enum_types_by_name['NestedFactory2Enum']
_MESSAGEWITHNESTEDENUMONLY_NESTEDENUM = _MESSAGEWITHNESTEDENUMONLY.enum_types_by_name['NestedEnum']
