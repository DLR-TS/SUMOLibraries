...
set_target_properties(thriftz::thriftz PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/thriftzmd.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/thriftzmd.dll"
  )

list(APPEND _cmake_import_check_targets thriftz::thriftz )
list(APPEND _cmake_import_check_files_for_thriftz::thriftz "${_IMPORT_PREFIX}/lib/thriftzmd.lib" "${_IMPORT_PREFIX}/bin/thriftzmd.dll" )
