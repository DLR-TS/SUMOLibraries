...
set_target_properties(thriftz::thriftz PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/bin/thriftzmdd.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/thriftzmdd.dll"
  )

list(APPEND _cmake_import_check_targets thriftz::thriftz )
list(APPEND _cmake_import_check_files_for_thriftz::thriftz "${_IMPORT_PREFIX}/bin/thriftzmdd.lib" "${_IMPORT_PREFIX}/bin/thriftzmdd.dll" )
