...
set_target_properties(thrift::thrift PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/thriftmd.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/thriftmd.dll"
  )

list(APPEND _cmake_import_check_targets thrift::thrift )
list(APPEND _cmake_import_check_files_for_thrift::thrift "${_IMPORT_PREFIX}/lib/thriftmd.lib" "${_IMPORT_PREFIX}/bin/thriftmd.dll" )
