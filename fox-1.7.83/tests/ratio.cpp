...
int main(int argc,char **argv){
  ...
  // Create main window
  FXMainWindow *main=new FXMainWindow(&application,"Ratio",nullptr,nullptr,DECOR_ALL,0,0,400,200,8,8,8,8,6,6);

  // Add quit button and connect it to application
  new FXButton(main,"&Quit",nullptr,&application,FXApp::ID_QUIT,FRAME_RAISED|FRAME_THICK|LAYOUT_SIDE_BOTTOM|LAYOUT_CENTER_X,0,0,0,0,20,20,2,2);

  // Label above it
  new FXLabel(main,"FXSpring can be used to keep widgets at fixed size ratios.\n\nResize the window to see how it behaves!",nullptr,LAYOUT_SIDE_TOP|LAYOUT_FILL_X);
  ...
  FXLabel *label1=new FXLabel(spring1,"1",nullptr,LAYOUT_FILL_X|LAYOUT_FILL_Y);
  ...
  FXLabel *label2=new FXLabel(spring2,"2",nullptr,LAYOUT_FILL_X|LAYOUT_FILL_Y);
  ...
  FXLabel *label3=new FXLabel(spring3,"3",nullptr,LAYOUT_FILL_X|LAYOUT_FILL_Y);
